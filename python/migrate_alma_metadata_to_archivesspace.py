...
def _resolve_slfs_location_refs(
    ...
    returning early once all are resolved.

    TODO: LSC to decide which ASpace field will be used to store the SLF-S code.
    ...
    for location in aspace_client.get_paged("/locations"):
        location_code = location.get("barcode")  # TODO: replace with correct field
        if location_code in slfs_codes:
            ...
            logger.info(f"Resolved SLF-S code '{location_code}' to {location['uri']}")
